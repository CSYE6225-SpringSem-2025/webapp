...
public class HealthCheckController {
    ...
    @GetMapping("/cicd2")
    public ResponseEntity<Void> cicdcheck2(@RequestBody(required = false) String body, @RequestParam Map<String, String> params) {
    ...
    @GetMapping("/cicd3")
    public ResponseEntity<Void> cicdcheck3(@RequestBody(required = false) String body, @RequestParam Map<String, String> params) {
        logger.info("CICD2 endpoint called");
